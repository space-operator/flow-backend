...
static __ID: Pubkey = Pubkey::new_from_array([
    11u8, 188u8, 15u8, 192u8, 187u8, 71u8, 202u8, 47u8, 116u8, 196u8, 17u8, 46u8, 148u8, 171u8,
    19u8, 207u8, 163u8, 198u8, 52u8, 229u8, 220u8, 23u8, 234u8, 203u8, 3u8, 205u8, 26u8, 35u8,
    205u8, 126u8, 120u8, 124u8,
]);
...
pub mod cpi {
    use super::*;
    pub fn noop_instruction<'a, 'b, 'c, 'info>(
        ctx: anchor_lang::context::CpiContext<'a, 'b, 'c, 'info, accounts::NoopInstruction>,
        data: Vec<u8>,
    ) -> anchor_lang::Result<()> {
        let ix = {
            let ix = internal::args::NoopInstruction { data };
    ...
    pub mod args {
        ...
        impl anchor_lang::Discriminator for NoopInstruction {
            const DISCRIMINATOR: &'static [u8] =
                &[112u8, 96u8, 44u8, 14u8, 37u8, 186u8, 6u8, 189u8];
        }
