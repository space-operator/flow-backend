...
static __ID:Pubkey = Pubkey::new_from_array([9u8,42u8,19u8,238u8,149u8,196u8,28u8,186u8,8u8,166u8,127u8,90u8,198u8,126u8,141u8,247u8,225u8,218u8,17u8,98u8,94u8,29u8,100u8,19u8,127u8,143u8,79u8,35u8,131u8,3u8,127u8,20u8,]);
const __ID_CONST:Pubkey = Pubkey::new_from_array([9u8,42u8,19u8,238u8,149u8,196u8,28u8,186u8,8u8,166u8,127u8,90u8,198u8,126u8,141u8,247u8,225u8,218u8,17u8,98u8,94u8,29u8,100u8,19u8,127u8,143u8,79u8,35u8,131u8,3u8,127u8,20u8,]);
...
pub mod types {
    ...
    pub struct ChangeLogEventV1 {
        pub id:Pubkey,pub path:Vec<PathNode> ,pub seq:u64,pub index:u32,
    }
    ...
    pub struct ConcurrentMerkleTreeHeader {
        pub account_type:CompressionAccountType,pub header:ConcurrentMerkleTreeHeaderData,
    }
    #[derive(Debug)]
    #[derive(Default)]
    #[derive(AnchorSerialize,AnchorDeserialize)]
    ...
    pub struct ConcurrentMerkleTreeHeaderDataV1 {
        pub max_buffer_size:u32,pub max_depth:u32,pub authority:Pubkey,pub creation_slot:u64,pub padding:[u8;
        6],
    }
    #[derive(Debug)]
    #[derive(Default)]
    ...
    pub enum AccountCompressionEvent {
        ChangeLog(ChangeLogEvent,),ApplicationData(ApplicationDataEvent,),
    }
    #[derive(Debug)]
    #[derive(AnchorSerialize,AnchorDeserialize)]
    #[derive(Clone)]
    ...
    pub enum CompressionAccountType {
        Uninitialized,ConcurrentMerkleTree,
    }
    #[derive(Debug)]
    #[derive(AnchorSerialize,AnchorDeserialize)]
    #[derive(Clone)]
...
pub mod cpi {
    use super:: * ;
    pub fn init_empty_merkle_tree<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::InitEmptyMerkleTree<'info> > ,max_depth:u32,max_buffer_size:u32) -> anchor_lang::Result<()>{
        let ix = {
    ...
    pub fn replace_leaf<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::ReplaceLeaf<'info> > ,root:[u8;
    32],previous_leaf:[u8;
    32],new_leaf:[u8;
    32],index:u32) -> anchor_lang::Result<()>{
        let ix = {
            let ix = internal::args::ReplaceLeaf {
                root,previous_leaf,new_leaf,index
            };
            let mut data = Vec::with_capacity(256);
    ...
    pub fn transfer_authority<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::TransferAuthority<'info> > ,new_authority:Pubkey) -> anchor_lang::Result<()>{
        let ix = {
            let ix = internal::args::TransferAuthority {
                new_authority
            };
            let mut data = Vec::with_capacity(256);
    ...
    pub fn verify_leaf<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::VerifyLeaf<'info> > ,root:[u8;
    32],leaf:[u8;
    32],index:u32) -> anchor_lang::Result<()>{
        let ix = {
            let ix = internal::args::VerifyLeaf {
                root,leaf,index
            };
            let mut data = Vec::with_capacity(256);
    ...
    pub fn append<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::Append<'info> > ,leaf:[u8;
    32]) -> anchor_lang::Result<()>{
        let ix = {
            let ix = internal::args::Append {
                leaf
            };
            let mut data = Vec::with_capacity(256);
    ...
    pub fn insert_or_append<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::InsertOrAppend<'info> > ,root:[u8;
    32],leaf:[u8;
    32],index:u32) -> anchor_lang::Result<()>{
        let ix = {
            let ix = internal::args::InsertOrAppend {
                root,leaf,index
            };
            let mut data = Vec::with_capacity(256);
    ...
    pub fn close_empty_tree<'a,'b,'c,'info>(ctx:anchor_lang::context::CpiContext<'a,'b,'c,'info,accounts::CloseEmptyTree<'info> > ,) -> anchor_lang::Result<()>{
        let ix = {
...
mod internal {
    ...
    pub mod args {
        ...
        pub struct InitEmptyMerkleTree {
            pub max_depth:u32,pub max_buffer_size:u32
        }
        impl anchor_lang::Discriminator for InitEmptyMerkleTree {
            const DISCRIMINATOR: &'static[u8] =  &[191u8,11u8,119u8,7u8,180u8,107u8,220u8,110u8];
        }
        ...
        pub struct ReplaceLeaf {
            pub root:[u8;
            32],pub previous_leaf:[u8;
            32],pub new_leaf:[u8;
            32],pub index:u32
        }
        impl anchor_lang::Discriminator for ReplaceLeaf {
            const DISCRIMINATOR: &'static[u8] =  &[204u8,165u8,76u8,100u8,73u8,147u8,0u8,128u8];
        }
        ...
        impl anchor_lang::Discriminator for TransferAuthority {
            const DISCRIMINATOR: &'static[u8] =  &[48u8,169u8,76u8,72u8,229u8,180u8,55u8,161u8];
        }
        ...
        impl anchor_lang::Discriminator for VerifyLeaf {
            const DISCRIMINATOR: &'static[u8] =  &[124u8,220u8,22u8,223u8,104u8,10u8,250u8,224u8];
        }
        ...
        impl anchor_lang::Discriminator for Append {
            const DISCRIMINATOR: &'static[u8] =  &[149u8,120u8,18u8,222u8,236u8,225u8,88u8,203u8];
        }
        ...
        impl anchor_lang::Discriminator for InsertOrAppend {
            const DISCRIMINATOR: &'static[u8] =  &[6u8,42u8,50u8,190u8,51u8,109u8,178u8,168u8];
        }
        ...
        impl anchor_lang::Discriminator for CloseEmptyTree {
            const DISCRIMINATOR: &'static[u8] =  &[50u8,14u8,219u8,107u8,78u8,103u8,16u8,103u8];
        }
    ...
    pub(crate)mod __cpi_client_accounts_init_empty_merkle_tree {
        ...
        pub struct InitEmptyMerkleTree<'info>{
            pub merkle_tree:anchor_lang::solana_program::account_info::AccountInfo<'info> ,pub authority:anchor_lang::solana_program::account_info::AccountInfo<'info> ,pub noop:anchor_lang::solana_program::account_info::AccountInfo<'info>
        }
        ...
        impl <'info>anchor_lang::ToAccountMetas for InitEmptyMerkleTree<'info>{
            fn to_account_metas(&self,is_signer:Option<bool>) -> Vec<anchor_lang::solana_program::instruction::AccountMeta>{
                ...
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(anchor_lang::Key::key(&self.noop),false));
                account_metas
            }
    ...
    pub(crate)mod __cpi_client_accounts_transfer_authority {
        ...
        pub struct TransferAuthority<'info>{
            pub merkle_tree:anchor_lang::solana_program::account_info::AccountInfo<'info> ,pub authority:anchor_lang::solana_program::account_info::AccountInfo<'info>
        }
        #[automatically_derived]
    ...
    pub(crate)mod __cpi_client_accounts_close_empty_tree {
        ...
        pub struct CloseEmptyTree<'info>{
            pub merkle_tree:anchor_lang::solana_program::account_info::AccountInfo<'info> ,pub authority:anchor_lang::solana_program::account_info::AccountInfo<'info> ,pub recipient:anchor_lang::solana_program::account_info::AccountInfo<'info>
        }
        #[automatically_derived]
        impl <'info>anchor_lang::ToAccountMetas for CloseEmptyTree<'info>{
            fn to_account_metas(&self,is_signer:Option<bool>) -> Vec<anchor_lang::solana_program::instruction::AccountMeta>{
                ...
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(anchor_lang::Key::key(&self.merkle_tree),false));
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(anchor_lang::Key::key(&self.authority),true));
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(anchor_lang::Key::key(&self.recipient),false));
                account_metas
            }
    ...
    pub(crate)mod __client_accounts_init_empty_merkle_tree {
        ...
        pub struct InitEmptyMerkleTree {
            pub merkle_tree:Pubkey,pub authority:Pubkey,pub noop:Pubkey
        }
        #[automatically_derived]
        impl anchor_lang::ToAccountMetas for InitEmptyMerkleTree {
            fn to_account_metas(&self,is_signer:Option<bool>) -> Vec<anchor_lang::solana_program::instruction::AccountMeta>{
                ...
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(self.noop,false));
                account_metas
            }
    ...
    pub(crate)mod __client_accounts_transfer_authority {
        ...
        #[derive(anchor_lang::AnchorSerialize)]
        pub struct TransferAuthority {
            pub merkle_tree:Pubkey,pub authority:Pubkey
        }
        #[automatically_derived]
    ...
    pub(crate)mod __client_accounts_close_empty_tree {
        ...
        #[derive(anchor_lang::AnchorSerialize)]
        pub struct CloseEmptyTree {
            pub merkle_tree:Pubkey,pub authority:Pubkey,pub recipient:Pubkey
        }
        #[automatically_derived]
        impl anchor_lang::ToAccountMetas for CloseEmptyTree {
            fn to_account_metas(&self,is_signer:Option<bool>) -> Vec<anchor_lang::solana_program::instruction::AccountMeta>{
                ...
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(self.merkle_tree,false));
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new_readonly(self.authority,true));
                account_metas.push(anchor_lang::solana_program::instruction::AccountMeta::new(self.recipient,false));
                account_metas
            }
