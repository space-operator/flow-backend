...
const NAME: &str = "initialize_group_member_pointer";
const DEFINITION: &str =
    flow_lib::node_definition!("spl_token_2022/group_member_pointer/initialize.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let ix = spl_token_2022_interface::extension::group_member_pointer::instruction::initialize(
