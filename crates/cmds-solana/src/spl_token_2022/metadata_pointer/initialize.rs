...
const NAME: &str = "initialize_metadata_pointer";
const DEFINITION: &str = flow_lib::node_definition!("spl_token_2022/metadata_pointer/initialize.jsonc");
