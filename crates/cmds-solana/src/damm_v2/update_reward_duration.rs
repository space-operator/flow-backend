...
const NAME: &str = "update_reward_duration";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/update_reward_duration.jsonc");
...
/// Instruction arguments for `update_reward_duration`.
...
pub struct Input {
    ...
    pub signer: Wallet,
    #[serde(flatten)]
    pub args: UpdateRewardDurationArgs,
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, signer, reward_index, new_duration
    #[tokio::test]
