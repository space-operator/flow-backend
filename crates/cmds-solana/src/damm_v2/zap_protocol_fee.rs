...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let token_vault = derive_token_vault(&input.pool, &input.token_mint);
    ...
    data.extend(borsh::to_vec(&input.max_amount)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, token_mint, receiver_token, operator, signer, max_amount
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "receiver_token" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
    ...
    async fn test_run() {
        ...
        let input = Input {
            ...
            receiver_token: Keypair::from_base58_string("4rQanLxTFvdgtLsGirizXejgYXACawB5ShoZgvz4wwXi4jnii7XHSyUFJbvAk4ojRiEAHvzK6Qnjq7UyJFNbydeQ").pubkey(),
