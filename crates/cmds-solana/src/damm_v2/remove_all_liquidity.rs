...
const NAME: &str = "remove_all_liquidity";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/remove_all_liquidity.jsonc");
...
/// Instruction arguments for `remove_all_liquidity`.
...
pub struct Input {
    ...
    #[serde(flatten)]
    pub args: RemoveAllLiquidityArgs,
...
mod tests {
    ...
    /// Required fields: owner, pool, position_nft_mint, token_a_account, token_b_account, token_a_mint, token_b_mint, token_a_amount_threshold, token_b_amount_threshold
    #[tokio::test]
