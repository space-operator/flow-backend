...
const NAME: &str = "close_config";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/close_config.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        AccountMeta::new(input.config, false),                     // config (writable, close)
...
mod tests {
    ...
    /// Required fields: fee_payer, config, operator, signer, rent_receiver
    #[tokio::test]
