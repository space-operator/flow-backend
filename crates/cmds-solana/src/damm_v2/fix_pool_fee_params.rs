...
const NAME: &str = "fix_pool_fee_params";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/fix_pool_fee_params.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, operator, signer, base_fee_data
    #[tokio::test]
