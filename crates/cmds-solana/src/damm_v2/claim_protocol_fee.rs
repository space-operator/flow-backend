...
const NAME: &str = "damm_v2_claim_protocol_fee";
const IX_NAME: &str = "claim_protocol_fee";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/claim_protocol_fee.jsonc");
...
/// Instruction arguments for `claim_protocol_fee`.
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, token_a_mint, token_b_mint, token_a_account, token_b_account, operator, signer, max_amount_a, max_amount_b
    #[tokio::test]
