...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new_readonly(input.pool, false),     // [1] pool (NOT writable)
...
mod tests {
    ...
    /// Required fields: owner, pool, position_nft_mint, token_a_account, token_b_account, token_a_mint, token_b_mint
    #[tokio::test]
