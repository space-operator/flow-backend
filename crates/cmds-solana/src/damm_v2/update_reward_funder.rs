...
const NAME: &str = "update_reward_funder";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/update_reward_funder.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    data.extend(borsh::to_vec(&input.new_funder)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, signer, reward_index, new_funder
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "reward_index" => 0_u8,
            "new_funder" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
            "submit" => false,
        };
    ...
    async fn test_run() {
        ...
        let input = Input {
            ...
            reward_index: 0,
            new_funder: Keypair::from_base58_string("4rQanLxTFvdgtLsGirizXejgYXACawB5ShoZgvz4wwXi4jnii7XHSyUFJbvAk4ojRiEAHvzK6Qnjq7UyJFNbydeQ").pubkey(),
            submit: false,
        };
