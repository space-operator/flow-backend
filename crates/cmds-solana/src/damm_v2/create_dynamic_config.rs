use super::{
    CP_AMM_PROGRAM_ID, SYSTEM_PROGRAM_ID, anchor_discriminator, derive_config,
    derive_event_authority,
};
use crate::prelude::*;
use solana_program::instruction::{AccountMeta, Instruction};

const NAME: &str = "create_dynamic_config";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/create_dynamic_config.jsonc");
...
mod tests {
    ...
    /// Required fields: payer, operator, signer, index, pool_creator_authority
    #[tokio::test]
