...
const NAME: &str = "initialize_pool_with_dynamic_config";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/initialize_pool_with_dynamic_config.jsonc");
...
pub struct Input {
    ...
    pub pool_creator_authority: Wallet,
    #[serde_as(as = "AsPubkey")]
    pub config: Pubkey,
    #[serde_as(as = "AsPubkey")]
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new_readonly(input.pool_creator_authority.pubkey(), true), // pool_creator_authority (signer)
    ...
    let ins = Instructions {
        ...
        signers: [input.payer, input.position_nft_mint, input.pool_creator_authority].into(),
...
mod tests {
    ...
    /// Required fields: payer, creator, position_nft_mint, pool_creator_authority, config, token_a_mint, token_b_mint, payer_token_a, payer_token_b, pool_fees, sqrt_min_price, sqrt_max_price, has_alpha_vault, liquidity, sqrt_price, activation_type, collect_fee_mode
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "pool_creator_authority" => "4rQanLxTFvdgtLsGirizXejgYXACawB5ShoZgvz4wwXi4jnii7XHSyUFJbvAk4ojRiEAHvzK6Qnjq7UyJFNbydeQ",
    ...
    async fn test_run() {
        ...
        let input = Input {
            ...
            pool_creator_authority: Keypair::from_base58_string("4rQanLxTFvdgtLsGirizXejgYXACawB5ShoZgvz4wwXi4jnii7XHSyUFJbvAk4ojRiEAHvzK6Qnjq7UyJFNbydeQ").into(),
