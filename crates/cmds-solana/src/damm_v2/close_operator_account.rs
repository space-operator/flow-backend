...
const NAME: &str = "close_operator_account";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/close_operator_account.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        AccountMeta::new(input.operator, false),                   // operator (writable, close)
...
mod tests {
    ...
    /// Required fields: fee_payer, operator, signer, rent_receiver
    #[tokio::test]
