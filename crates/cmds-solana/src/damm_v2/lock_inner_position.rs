...
const NAME: &str = "lock_inner_position";
const DEFINITION: &str = flow_lib::node_definition!("damm_v2/lock_inner_position.jsonc");
...
/// Instruction arguments for `lock_inner_position`.
#[derive(Serialize, Deserialize, Debug, borsh::BorshSerialize)]
pub struct LockInnerPositionArgs {
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let args = LockInnerPositionArgs {
...
mod tests {
    ...
    /// Required fields: fee_payer, pool, position_nft_mint, owner, period_frequency, cliff_unlock_liquidity, liquidity_per_period, number_of_period
    #[tokio::test]
