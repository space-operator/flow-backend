use super::{DISC_WITHDRAW_FROM_TREASURY, TOKEN_PROGRAM_ID, build_auction_house_instruction, pda};
use crate::prelude::*;
use solana_program::instruction::AccountMeta;

const NAME: &str = "auction_house_withdraw_from_treasury";
const DEFINITION: &str = flow_lib::node_definition!("auction_house/withdraw_from_treasury.jsonc");
...
mod tests {
    ...
    fn test_input_parsing() {
        ...
        let input = value::map! {
            ...
            "treasury_mint" => pk, "treasury_withdrawal_destination" => pk,
    ...
    fn test_instruction_construction() {
        ...
        assert_eq!(ix.data[..8], DISC_WITHDRAW_FROM_TREASURY);
