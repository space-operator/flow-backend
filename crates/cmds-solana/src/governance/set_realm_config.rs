...
use super::{RealmConfigArgs, create_realm::with_governing_token_config_args, prelude::*};
...
fn build() -> BuildResult {
    const DEFINITION: &str = flow_lib::node_definition!("/governance/set_realm_config.jsonc");
