...
fn build() -> BuildResult {
    const DEFINITION: &str = flow_lib::node_definition!("/governance/create_native_treasury.jsonc");
...
mod tests {
    ...
    fn test_instruction_builder() {
        ...
        let (ix, _addr) = create_native_treasury(&SPL_GOVERNANCE_ID, &governance, &payer);
