...
use super::{GovernanceInstruction, SPL_GOVERNANCE_ID, with_realm_config_accounts};
...
fn build() -> BuildResult {
    const DEFINITION: &str = flow_lib::node_definition!("/governance/finalize_vote.jsonc");
