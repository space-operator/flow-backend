...
const NAME: &str = "withdraw_referrer_fees";
const DEFINITION: &str = flow_lib::node_definition!("klend/withdraw_referrer_fees.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new(input.referrer_token_state, false),
        AccountMeta::new(input.reserve, false),
        AccountMeta::new(input.reserve_supply_liquidity, false),
        AccountMeta::new(input.referrer_token_account, false),
...
mod tests {
    ...
    /// Required fields: fee_payer, referrer, referrer_token_state, reserve, reserve_supply_liquidity, referrer_token_account, lending_market, lending_market_authority
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "referrer_token_state" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
            ...
            "referrer_token_account" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
