...
const NAME: &str = "request_elevation_group";
const DEFINITION: &str = flow_lib::node_definition!("klend/request_elevation_group.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    data.extend(borsh::to_vec(&input.elevation_group)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, obligation, lending_market, elevation_group
    #[tokio::test]
