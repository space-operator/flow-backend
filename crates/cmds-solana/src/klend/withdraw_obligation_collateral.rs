...
const NAME: &str = "withdraw_obligation_collateral";
const DEFINITION: &str = flow_lib::node_definition!("klend/withdraw_obligation_collateral.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, obligation, lending_market, withdraw_reserve, reserve_source_collateral, user_destination_collateral, instruction_sysvar_account, collateral_amount
    #[tokio::test]
