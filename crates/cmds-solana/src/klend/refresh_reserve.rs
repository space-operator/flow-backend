...
const NAME: &str = "refresh_reserve";
const DEFINITION: &str = flow_lib::node_definition!("klend/refresh_reserve.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, reserve, lending_market
    #[tokio::test]
