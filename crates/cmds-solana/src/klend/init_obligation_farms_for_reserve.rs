use super::{
    KLEND_PROGRAM_ID, SYSTEM_PROGRAM_ID, anchor_discriminator, derive_lending_market_authority,
};
use crate::prelude::*;
use solana_program::instruction::{AccountMeta, Instruction};

const NAME: &str = "init_obligation_farms_for_reserve";
const DEFINITION: &str =
    flow_lib::node_definition!("klend/init_obligation_farms_for_reserve.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new(input.obligation_farm, false),
...
mod tests {
    ...
    /// Required fields: fee_payer, payer, owner, obligation, reserve, reserve_farm_state, obligation_farm, lending_market, farms_program, mode
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "obligation_farm" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
