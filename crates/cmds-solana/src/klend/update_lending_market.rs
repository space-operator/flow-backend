...
const NAME: &str = "update_lending_market";
const DEFINITION: &str = flow_lib::node_definition!("klend/update_lending_market.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, lending_market_owner, lending_market, mode, value
    #[tokio::test]
