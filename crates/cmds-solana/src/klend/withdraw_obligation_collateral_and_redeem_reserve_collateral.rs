...
const NAME: &str = "withdraw_obligation_collateral_and_redeem_reserve_collateral";
const DEFINITION: &str = flow_lib::node_definition!("klend/withdraw_obligation_collateral_and_redeem_reserve_collateral.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, obligation, lending_market, lending_market_authority, withdraw_reserve, reserve_source_collateral, reserve_collateral_mint, reserve_liquidity_supply, user_destination_liquidity, user_destination_collateral, instruction_sysvar_account, collateral_amount
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "reserve_source_collateral" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
