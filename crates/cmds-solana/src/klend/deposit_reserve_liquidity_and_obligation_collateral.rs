...
const NAME: &str = "deposit_reserve_liquidity_and_obligation_collateral";
const DEFINITION: &str = flow_lib::node_definition!("klend/deposit_reserve_liquidity_and_obligation_collateral.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, obligation, lending_market, lending_market_authority, reserve, reserve_liquidity_supply, reserve_collateral_mint, reserve_destination_deposit_collateral, user_source_liquidity, user_destination_collateral, instruction_sysvar_account, liquidity_amount
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "reserve_destination_deposit_collateral" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
