...
const NAME: &str = "redeem_reserve_collateral";
const DEFINITION: &str = flow_lib::node_definition!("klend/redeem_reserve_collateral.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, lending_market, reserve, reserve_collateral_mint, reserve_liquidity_supply, user_source_collateral, user_destination_liquidity, collateral_amount
    #[tokio::test]
