...
const NAME: &str = "refresh_obligation";
const DEFINITION: &str = flow_lib::node_definition!("klend/refresh_obligation.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, lending_market, obligation
    #[tokio::test]
