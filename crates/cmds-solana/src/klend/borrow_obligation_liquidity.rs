...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new(input.borrow_reserve, false),
        AccountMeta::new(input.reserve_source_liquidity, false),
        AccountMeta::new(input.borrow_reserve_liquidity_fee_receiver, false),
...
mod tests {
    ...
    /// Required fields: fee_payer, owner, obligation, lending_market, lending_market_authority, borrow_reserve, reserve_source_liquidity, borrow_reserve_liquidity_fee_receiver, user_destination_liquidity, instruction_sysvar_account, liquidity_amount
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "borrow_reserve" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
            "reserve_source_liquidity" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
            "borrow_reserve_liquidity_fee_receiver" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
