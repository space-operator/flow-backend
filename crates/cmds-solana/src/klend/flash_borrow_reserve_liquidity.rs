...
const NAME: &str = "flash_borrow_reserve_liquidity";
const DEFINITION: &str = flow_lib::node_definition!("klend/flash_borrow_reserve_liquidity.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, user_transfer_authority, lending_market_authority, lending_market, reserve, reserve_source_liquidity, user_destination_liquidity, reserve_liquidity_fee_receiver, sysvar_info, liquidity_amount
    #[tokio::test]
