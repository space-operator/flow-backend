...
const NAME: &str = "create_nonce_account_with_seed";
const DEFINITION: &str =
    flow_lib::node_definition!("system_program/create_nonce_account_with_seed.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    // Returns Vec<Instruction> (CreateAccountWithSeed + InitializeNonceAccount)
    let ixs = system_instruction::create_nonce_account_with_seed(
        &from_pubkey,
        &input.nonce_account,
        &base_pubkey,
        &input.seed,
