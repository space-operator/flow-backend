...
const NAME: &str = "assign_with_seed";
const DEFINITION: &str = flow_lib::node_definition!("system_program/assign_with_seed.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let ix = system_instruction::assign_with_seed(
        &input.account,
        &base_pubkey,
        &input.seed,
        &input.owner,
