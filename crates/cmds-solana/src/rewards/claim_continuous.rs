...
const NAME: &str = "claim_continuous";
const DEFINITION: &str = flow_lib::node_definition!("rewards/claim_continuous.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction =
        build_rewards_instruction(RewardsDiscriminator::ClaimContinuous, accounts, args_data);
