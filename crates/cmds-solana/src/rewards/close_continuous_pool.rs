...
const NAME: &str = "close_continuous_pool";
const DEFINITION: &str = flow_lib::node_definition!("rewards/close_continuous_pool.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction =
        build_rewards_instruction(RewardsDiscriminator::CloseContinuousPool, accounts, vec![]);
