...
use crate::prelude::*;
use mpl_bubblegum::instructions::RedeemBuilder;
use solana_program::instruction::AccountMeta;
use solana_program::pubkey::Pubkey;
use std::str::FromStr;

const NAME: &str = "redeem_cNFT";

const DEFINITION: &str = flow_lib::node_definition!("mpl_bubblegum/redeem.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let leaf_delegate = input.leaf_delegate.unwrap_or(input.leaf_owner.pubkey());
