...
use crate::prelude::*;
use mpl_bubblegum::instructions::VerifyCollectionBuilder;
use solana_program::instruction::AccountMeta;
use solana_program::pubkey::Pubkey;
use std::str::FromStr;

const NAME: &str = "verify_collection_cNFT";

const DEFINITION: &str = flow_lib::node_definition!("mpl_bubblegum/verify_collection.jsonc");
