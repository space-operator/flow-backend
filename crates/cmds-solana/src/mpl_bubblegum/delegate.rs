...
use crate::prelude::*;
use mpl_bubblegum::instructions::DelegateBuilder;
use solana_program::instruction::AccountMeta;
use solana_program::pubkey::Pubkey;
use std::str::FromStr;

const NAME: &str = "delegate_cNFT";

const DEFINITION: &str = flow_lib::node_definition!("mpl_bubblegum/delegate.jsonc");
...
pub struct Input {
    ...
    pub previous_leaf_delegate: Option<Pubkey>,
    //
