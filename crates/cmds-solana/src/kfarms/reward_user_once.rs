...
const NAME: &str = "reward_user_once";
const DEFINITION: &str = flow_lib::node_definition!("kfarms/reward_user_once.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, farm_admin, farm_state, user_state, reward_index, amount
    #[tokio::test]
