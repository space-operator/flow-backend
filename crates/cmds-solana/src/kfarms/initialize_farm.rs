...
const NAME: &str = "initialize_farm";
const DEFINITION: &str = flow_lib::node_definition!("kfarms/initialize_farm.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, farm_admin, farm_state, global_config, farm_vault, farm_vaults_authority, token_mint
    #[tokio::test]
