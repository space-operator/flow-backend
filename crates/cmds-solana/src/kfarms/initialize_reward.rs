...
mod tests {
    ...
    /// Required fields: fee_payer, farm_admin, farm_state, global_config, reward_vault, reward_treasury_vault, farm_vaults_authority, treasury_vaults_authority, reward_mint
    #[tokio::test]
