...
const NAME: &str = "refresh_user_state";
const DEFINITION: &str = flow_lib::node_definition!("kfarms/refresh_user_state.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, user_state, farm_state
    #[tokio::test]
