...
const NAME: &str = "kvault_deposit";
const IX_NAME: &str = "deposit";
const DEFINITION: &str = flow_lib::node_definition!("kvault/deposit.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, user, vault_state, token_vault, token_mint, base_vault_authority, shares_mint, klend_program, shares_token_program, event_authority, program, max_amount
    #[tokio::test]
