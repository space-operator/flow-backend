...
const NAME: &str = "remove_allocation";
const DEFINITION: &str = flow_lib::node_definition!("kvault/remove_allocation.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let data = anchor_discriminator("remove_allocation").to_vec();
...
mod tests {
    ...
    /// Required fields: fee_payer, vault_admin_authority, vault_state, reserve
    #[tokio::test]
