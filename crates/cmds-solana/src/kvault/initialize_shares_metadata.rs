...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new_readonly(input.shares_mint, false),          // shares_mint
    ...
    let mut data = anchor_discriminator("initialize_shares_metadata").to_vec();
...
mod tests {
    ...
    /// Required fields: fee_payer, vault_admin_authority, vault_state, shares_mint, base_vault_authority, shares_metadata, metadata_program, name, symbol, uri
    #[tokio::test]
