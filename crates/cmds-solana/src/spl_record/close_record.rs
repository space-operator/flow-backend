...
const NAME: &str = "close_record";

const DEFINITION: &str = flow_lib::node_definition!("spl_record/close_record.jsonc");
...
pub struct Input {
    ...
    #[serde(default)]
    lamport_receiver: Option<Pubkey>,
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = record_instruction::close_account(
