...
const NAME: &str = "smart_account_close_batch_transaction";
const DEFINITION: &str = flow_lib::node_definition!("smart_account/close_batch_transaction.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = build_instruction("close_batch_transaction", accounts, vec![]);
