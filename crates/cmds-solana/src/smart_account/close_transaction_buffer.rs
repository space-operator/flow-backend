...
const NAME: &str = "smart_account_close_transaction_buffer";
const DEFINITION: &str = flow_lib::node_definition!("smart_account/close_transaction_buffer.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = build_instruction("close_transaction_buffer", accounts, vec![]);
