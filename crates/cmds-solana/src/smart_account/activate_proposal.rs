...
const NAME: &str = "smart_account_activate_proposal";
const DEFINITION: &str = flow_lib::node_definition!("smart_account/activate_proposal.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = build_instruction("activate_proposal", accounts, vec![]);
