...
const NAME: &str = "smart_account_cancel_proposal";
const DEFINITION: &str = flow_lib::node_definition!("smart_account/cancel_proposal.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = build_instruction("cancel_proposal", accounts, args_data);
