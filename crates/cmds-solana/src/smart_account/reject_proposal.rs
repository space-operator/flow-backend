...
const NAME: &str = "smart_account_reject_proposal";
const DEFINITION: &str = flow_lib::node_definition!("smart_account/reject_proposal.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = build_instruction("reject_proposal", accounts, args_data);
