use super::{
    MERKLE_DISTRIBUTOR_PROGRAM_ID, SYSTEM_PROGRAM_ID, TOKEN_PROGRAM_ID, anchor_discriminator,
};
use crate::prelude::*;
use solana_program::instruction::{AccountMeta, Instruction};

const NAME: &str = "claim_locked";
const DEFINITION: &str = flow_lib::node_definition!("merkle_distributor/claim_locked.jsonc");
