...
const NAME: &str = "set_enable_slot";
const DEFINITION: &str = flow_lib::node_definition!("merkle_distributor/set_enable_slot.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, distributor, admin, enable_slot
    #[tokio::test]
