//! Jupiter Prediction Search Events - Search prediction events
//!
//! Jupiter API: GET /prediction/v1/events/search
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let url = "https://api.jup.ag/prediction/v1/events/search".to_string();
