//! Jupiter Tokens Recent - Get recently created tokens
//!
//! Jupiter API: GET /tokens/v2/recent

use crate::prelude::*;

pub const NAME: &str = "jupiter_tokens_recent";
const DEFINITION: &str = flow_lib::node_definition!("jupiter/jupiter_tokens_recent.jsonc");
