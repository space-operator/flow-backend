//! Jupiter Prediction Unfollow User - Unfollow a prediction user
//!
//! Jupiter API: POST /prediction/v1/unfollow
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let url = "https://api.jup.ag/prediction/v1/unfollow".to_string();
