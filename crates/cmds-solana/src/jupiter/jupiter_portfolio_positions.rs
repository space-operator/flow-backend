//! Jupiter Portfolio Positions - Get DeFi positions for address
//!
//! Jupiter API: GET /portfolio/v1/positions/{address}

use crate::prelude::*;

pub const NAME: &str = "jupiter_portfolio_positions";
const DEFINITION: &str = flow_lib::node_definition!("jupiter/jupiter_portfolio_positions.jsonc");
