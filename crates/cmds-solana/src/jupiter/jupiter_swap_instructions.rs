//! Jupiter Swap Instructions - Get swap instructions from quote
//!
//! Jupiter API: POST /swap/v1/swap-instructions

use crate::prelude::*;
use serde_json::json;

pub const NAME: &str = "jupiter_swap_instructions";
const DEFINITION: &str = flow_lib::node_definition!("jupiter/jupiter_swap_instructions.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let url = "https://api.jup.ag/swap/v1/swap-instructions".to_string();
