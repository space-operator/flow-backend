use crate::prelude::*;
use mpl_core::instructions::RemovePluginV1Builder;
use mpl_core::types::PluginType;

const NAME: &str = "remove_plugin_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/remove_plugin_v1.jsonc");
