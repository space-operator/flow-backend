use crate::prelude::*;
use mpl_core::instructions::AddCollectionPluginV1Builder;
use mpl_core::types::{PluginAuthority, Plugin};

const NAME: &str = "add_collection_plugin_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/add_collection_plugin_v1.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let mut builder = AddCollectionPluginV1Builder::new();
    builder
