use crate::prelude::*;
use mpl_core::instructions::AddExternalPluginAdapterV1Builder;
use mpl_core::types::ExternalPluginAdapterInitInfo;

const NAME: &str = "add_external_plugin_adapter_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/add_external_plugin_adapter_v1.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, asset, payer, init_info
    #[tokio::test]
