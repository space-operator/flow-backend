use crate::prelude::*;
use mpl_core::instructions::CompressV1Builder;

const NAME: &str = "compress_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/compress_v1.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = CompressV1Builder::new()
        .asset(input.asset)
        .payer(payer)
        .instruction();
...
mod tests {
    ...
    /// Required fields: fee_payer, asset, payer
    #[tokio::test]
