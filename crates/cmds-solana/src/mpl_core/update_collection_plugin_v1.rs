use crate::prelude::*;
use mpl_core::instructions::UpdateCollectionPluginV1Builder;
use mpl_core::types::Plugin;

const NAME: &str = "update_collection_plugin_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/update_collection_plugin_v1.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = UpdateCollectionPluginV1Builder::new()
...
mod tests {
    ...
    /// Required fields: fee_payer, collection, payer, plugin
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "plugin" => serde_json::json!({"BurnDelegate": {}}),
            "submit" => false,
        };
