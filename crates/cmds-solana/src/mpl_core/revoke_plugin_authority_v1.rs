use crate::prelude::*;
use mpl_core::instructions::RevokePluginAuthorityV1Builder;
use mpl_core::types::PluginType;

const NAME: &str = "revoke_plugin_authority_v1";
const DEFINITION: &str = flow_lib::node_definition!("mpl_core/revoke_plugin_authority_v1.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let instruction = RevokePluginAuthorityV1Builder::new()
        .asset(input.asset)
        .payer(payer)
...
mod tests {
    ...
    /// Required fields: fee_payer, asset, payer, plugin_type
    #[tokio::test]
