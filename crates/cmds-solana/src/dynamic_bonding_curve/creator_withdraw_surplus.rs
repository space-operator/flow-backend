...
const NAME: &str = "creator_withdraw_surplus";
const DEFINITION: &str = flow_lib::node_definition!("dynamic_bonding_curve/creator_withdraw_surplus.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let data = discriminators::CREATOR_WITHDRAW_SURPLUS.to_vec();
