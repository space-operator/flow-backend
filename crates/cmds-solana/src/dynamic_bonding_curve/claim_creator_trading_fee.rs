...
const NAME: &str = "claim_creator_trading_fee";
const DEFINITION: &str = flow_lib::node_definition!("dynamic_bonding_curve/claim_creator_trading_fee.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let mut data = discriminators::CLAIM_CREATOR_TRADING_FEE.to_vec();
