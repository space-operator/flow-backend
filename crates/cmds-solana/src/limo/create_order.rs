...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    data.extend(borsh::to_vec(&input.output_amount)?);
    data.extend(borsh::to_vec(&input.order_type)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, maker, global_config, pda_authority, order, input_mint, output_mint, input_vault, input_token_program, output_token_program, event_authority, program, input_amount, output_amount, order_type
    #[tokio::test]
