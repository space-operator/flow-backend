...
const DEFINITION: &str = flow_lib::node_definition!("limo/initialize_global_config.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, pda_authority, global_config
    #[tokio::test]
