...
const NAME: &str = "revoke_operator";
const DEFINITION: &str = flow_lib::node_definition!("presale/revoke_operator.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let data = discriminators::REVOKE_OPERATOR.to_vec();
