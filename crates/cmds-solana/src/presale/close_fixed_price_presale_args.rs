...
const NAME: &str = "close_fixed_price_presale_args";
const DEFINITION: &str = flow_lib::node_definition!("presale/close_fixed_price_presale_args.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        AccountMeta::new(input.fixed_price_presale_args, false), // fixed_price_presale_args (writable)
    ...
    let data = discriminators::CLOSE_FIXED_PRICE_PRESALE_ARGS.to_vec();
...
mod tests {
    ...
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "fixed_price_presale_args" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
