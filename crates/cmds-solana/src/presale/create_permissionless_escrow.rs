...
const NAME: &str = "create_permissionless_escrow";
const DEFINITION: &str = flow_lib::node_definition!("presale/create_permissionless_escrow.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let data = discriminators::CREATE_PERMISSIONLESS_ESCROW.to_vec();
