...
const NAME: &str = "create_ephemeral_ata_permission";
const DEFINITION: &str =
    flow_lib::node_definition!("magicblock/create_ephemeral_ata_permission.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let mut data = discriminators::CREATE_EPHEMERAL_ATA_PERMISSION.to_vec();
