...
const NAME: &str = "withdraw_through_delegated_shuttle_with_merge";
const DEFINITION: &str =
    flow_lib::node_definition!("magicblock/withdraw_through_delegated_shuttle_with_merge.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let accounts = vec![
        ...
        AccountMeta::new(input.owner_token, false), // owner_token (writable)
    ...
    let mut data = discriminators::WITHDRAW_THROUGH_DELEGATED_SHUTTLE_WITH_MERGE.to_vec();
