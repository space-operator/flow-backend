...
const NAME: &str = "initialize_rent_pda";
const DEFINITION: &str = flow_lib::node_definition!("magicblock/initialize_rent_pda.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let data = discriminators::INITIALIZE_RENT_PDA.to_vec();
