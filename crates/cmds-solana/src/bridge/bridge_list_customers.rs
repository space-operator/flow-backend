...
pub const NAME: &str = "bridge_list_customers";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_customers.jsonc");
...
mod tests {
    ...
    fn test_deserialize_response() {
        let json = std::fs::read_to_string(
            format!("{}/tests/fixtures/customer_list.json", env!("CARGO_MANIFEST_DIR"))
        ).unwrap();
        let _parsed: crate::bridge::response_types::PaginatedList<crate::bridge::response_types::Customer> = serde_json::from_str(&json).unwrap();
    }
