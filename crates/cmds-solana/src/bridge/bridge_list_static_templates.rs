...
pub const NAME: &str = "bridge_list_static_templates";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_static_templates.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = "/v0/transfers/static_templates";
...
mod tests {
    ...
    async fn test_live_list_static_templates() {
        ...
        let resp = client
            .get("https://api.sandbox.bridge.xyz/v0/transfers/static_templates")
