...
pub const NAME: &str = "bridge_get_customer_rewards_history";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_get_customer_rewards_history.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/rewards/{}/customer/{}/history", input.currency, input.customer_id);
