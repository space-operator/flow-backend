...
pub const NAME: &str = "bridge_list_prefunded_accounts";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_prefunded_accounts.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = "/v0/prefunded_accounts";
...
mod tests {
    ...
    #[tokio::test]
    #[ignore]
    async fn test_live_list_prefunded_accounts() {
        ...
        let resp = client
            .get("https://api.sandbox.bridge.xyz/v0/prefunded_accounts")
