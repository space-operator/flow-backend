...
pub const NAME: &str = "bridge_list_card_authorizations";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_card_authorizations.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/customers/{}/card_accounts/{}/authorizations", input.customer_id, input.card_account_id);
