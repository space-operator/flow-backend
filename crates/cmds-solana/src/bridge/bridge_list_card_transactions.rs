...
pub const NAME: &str = "bridge_list_card_transactions";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_card_transactions.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/customers/{}/card_accounts/{}/transactions", input.customer_id, input.card_account_id);
