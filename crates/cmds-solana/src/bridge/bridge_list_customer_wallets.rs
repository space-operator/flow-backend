...
pub const NAME: &str = "bridge_list_customer_wallets";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_customer_wallets.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/customers/{}/wallets", input.customer_id);
