...
const DEFINITION: &str =
    flow_lib::node_definition!("bridge/bridge_list_liquidation_addresses.jsonc");
...
mod tests {
    ...
    fn test_deserialize_response() {
        let json = std::fs::read_to_string(format!(
            "{}/tests/fixtures/liquidation_address_list.json",
            env!("CARGO_MANIFEST_DIR")
        ))
        .unwrap();
        let _parsed: crate::bridge::response_types::PaginatedList<
            crate::bridge::response_types::LiquidationAddress,
