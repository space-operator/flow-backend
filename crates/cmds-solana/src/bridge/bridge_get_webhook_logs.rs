...
pub const NAME: &str = "bridge_get_webhook_logs";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_get_webhook_logs.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/webhooks/{}/logs", input.webhook_id);
