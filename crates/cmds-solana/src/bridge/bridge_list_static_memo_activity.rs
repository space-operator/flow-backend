...
pub const NAME: &str = "bridge_list_static_memo_activity";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_static_memo_activity.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = "/v0/static_memos/history";
...
mod tests {
    ...
    #[tokio::test]
    #[ignore]
    async fn test_live_list_static_memo_activity() {
        ...
        let resp = client
            .get("https://api.sandbox.bridge.xyz/v0/static_memos/history")
