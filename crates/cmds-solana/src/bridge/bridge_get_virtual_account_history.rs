...
pub const NAME: &str = "bridge_get_virtual_account_history";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_get_virtual_account_history.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/customers/{}/virtual_accounts/{}/history", input.customer_id, input.virtual_account_id);
