...
pub const NAME: &str = "bridge_list_webhook_events";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_webhook_events.jsonc");
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/webhooks/{}/events", input.webhook_id);
