...
pub const NAME: &str = "bridge_get_prefunded_account_history";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_get_prefunded_account_history.jsonc");
...
pub struct Input {
    pub api_key: String,
    pub prefunded_account_id: String,
    #[serde(default)]
...
async fn run(ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let path = format!("/v0/prefunded_accounts/{}/history", input.prefunded_account_id);
