...
pub const NAME: &str = "bridge_list_associated_persons";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_associated_persons.jsonc");
...
mod tests {
    ...
    #[tokio::test]
    #[ignore]
    async fn test_live_list_associated_persons() {
        ...
        let resp = client
            .get(format!("https://api.sandbox.bridge.xyz/v0/customers/{customer_id}/associated_persons"))
            .header("Api-Key", &api_key)
            .query(&[("limit", "2")])
