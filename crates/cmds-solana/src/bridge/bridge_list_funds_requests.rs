...
pub const NAME: &str = "bridge_list_funds_requests";
const DEFINITION: &str = flow_lib::node_definition!("bridge/bridge_list_funds_requests.jsonc");
...
mod tests {
    ...
    async fn test_live_list_funds_requests() {
        ...
        let resp = client
            .get("https://api.sandbox.bridge.xyz/v0/funds_requests")
