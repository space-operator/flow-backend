...
const NAME: &str = "swap_uneven_vaults";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/swap_uneven_vaults.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let accounts = vec![
        ...
        AccountMeta::new_readonly(input.raydium_pool_config_or_base_vault_authority, false), // raydium_pool_config_or_base_vault_authority (readonly)
...
mod tests {
    ...
    /// Required fields: fee_payer, actions_authority, strategy, global_config, token_a_vault, token_b_vault, base_vault_authority, pool, position, raydium_pool_config_or_base_vault_authority, pool_token_vault_a, pool_token_vault_b, tick_array0, tick_array1, tick_array2, oracle, pool_program, scope_prices, token_infos, target_limit_bps
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "raydium_pool_config_or_base_vault_authority" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
