...
const NAME: &str = "update_collateral_info";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/update_collateral_info.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let accounts = vec![
        ...
        AccountMeta::new(input.token_infos, false),              // token_infos (writable)
    ];
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, global_config, token_infos, index, mode, value
    #[tokio::test]
