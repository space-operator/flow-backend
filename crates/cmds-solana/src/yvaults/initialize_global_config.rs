...
const NAME: &str = "yvaults_initialize_global_config";
const IX_NAME: &str = "initialize_global_config";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/initialize_global_config.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let accounts = vec![
        ...
        AccountMeta::new(input.global_config, false),            // global_config (writable - init)
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, global_config
    #[tokio::test]
