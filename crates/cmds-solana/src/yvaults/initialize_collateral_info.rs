...
const NAME: &str = "initialize_collateral_info";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/initialize_collateral_info.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    let accounts = vec![
        ...
        AccountMeta::new(input.coll_info, false),               // coll_info (writable - init)
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, global_config, coll_info
    #[tokio::test]
    async fn test_input_parsing() {
        let input = value::map! {
            ...
            "coll_info" => "GQZRKDqVzM4DXGGMEUNdnBD3CC4TTywh3PwgjYPBm8W9",
            "submit" => false,
        };
