...
const NAME: &str = "executive_withdraw";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/executive_withdraw.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    data.extend(borsh::to_vec(&input.action)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, strategy, global_config, pool, position, raydium_protocol_position_or_base_vault_authority, position_token_account, tick_array_lower, tick_array_upper, token_a_vault, token_b_vault, base_vault_authority, pool_token_vault_a, pool_token_vault_b, token_a_mint, token_b_mint, scope_prices, token_infos, pool_program, action
    #[tokio::test]
