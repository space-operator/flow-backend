...
const NAME: &str = "initialize_kamino_reward";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/initialize_kamino_reward.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, strategy, global_config, reward_mint, reward_vault, token_infos, base_vault_authority, kamino_reward_index, collateral_token
    #[tokio::test]
