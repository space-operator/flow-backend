...
const NAME: &str = "yvaults_update_global_config";
const IX_NAME: &str = "update_global_config";
const DEFINITION: &str = flow_lib::node_definition!("yvaults/update_global_config.jsonc");
...
async fn run(mut ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    data.extend(borsh::to_vec(&input.key)?);
...
mod tests {
    ...
    /// Required fields: fee_payer, admin_authority, global_config, key, index, value
    #[tokio::test]
