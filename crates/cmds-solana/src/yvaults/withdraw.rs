...
const DEFINITION: &str = flow_lib::node_definition!("yvaults/withdraw.jsonc");
...
mod tests {
    ...
    /// Required fields: fee_payer, user, strategy, global_config, pool, position, raydium_protocol_position_or_base_vault_authority, tick_array_lower, tick_array_upper, token_a_vault, token_b_vault, base_vault_authority, pool_token_vault_a, pool_token_vault_b, token_a_ata, token_b_ata, shares_mint, treasury_fee_token_a_vault, treasury_fee_token_b_vault, position_token_account, pool_program, instruction_sysvar_account, shares_amount
    #[tokio::test]
