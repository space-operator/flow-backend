...
impl NftTraits {
    pub fn new(r: &RenderParams, effects: &EffectsList) -> Self {
        Self {
            ...
            season: match r.fx2 {
                super::Fx2::Spring => super::Fx2::Spring,
                super::Fx2::Fall => super::Fx2::Fall,
                super::Fx2::No => super::Fx2::No,
                super::Fx2::Butterflies => super::Fx2::No,
                super::Fx2::Underwater => super::Fx2::No,
                super::Fx2::Fireflyies => super::Fx2::No,
                super::Fx2::Ladybag => super::Fx2::No,
            },
            weather: r.fx4,
            smoke: r.fx3,
            growth: r.fx5,
