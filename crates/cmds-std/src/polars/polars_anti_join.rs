...
pub const NAME: &str = "polars_anti_join";
const DEFINITION: &str = flow_lib::node_definition!("polars/polars_anti_join.jsonc");
...
async fn run(_ctx: CommandContext, input: Input) -> Result<Output, CommandError> {
    ...
    let mut result = left
        ...
        .map_err(|e| CommandError::msg(format!("Anti join error: {e}")))?;
